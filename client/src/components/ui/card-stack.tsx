...
function DefaultFanCard({ item }: { item: CardStackItem; active: boolean }) {
    return (
        <div className={cn("relative h-full w-full flex flex-col justify-between p-6 rounded-2xl overflow-hidden", item.color || "bg-white dark:bg-slate-800")}>
            {/* abstract pattern for texture */}
            <div className="absolute top-0 right-0 p-4 opacity-10">
                <svg width="60" height="60" viewBox="0 0 24 24" fill="currentColor" className="text-foreground">
                    <path d="M14.017 21L14.017 18C14.017 16.8954 13.1216 16 12.017 16H9.01699V12.9996H12.017C13.1216 12.9996 14.017 12.1042 14.017 10.9996V7.99961H17.017V10.9996C17.017 12.1042 17.9124 12.9996 19.017 12.9996H22.017V16H19.017C17.9124 16 17.017 16.8954 17.017 18V21H14.017ZM8.01699 10.9996H11.017V7.99961H8.01699C6.91242 7.99961 6.01699 7.10418 6.01699 5.99961V3.00001H3.01699V5.99961C3.01699 7.10418 3.91242 7.99961 5.01699 7.99961H8.01699V10.9996Z" />
                </svg>
            </div>

            {/* Content: Large Note */}
            <div className="flex-1 flex items-center justify-center">
                <p className="text-xl md:text-2xl font-medium text-slate-800 dark:text-slate-100 leading-relaxed italic text-center">
                    "{item.description}"
                </p>
            </div>

            {/* Footer: Name & Date */}
            <div className="flex flex-col items-center border-t border-black/5 dark:border-white/10 pt-4 mt-4">
